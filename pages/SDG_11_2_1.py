...
if choice_selected1 == 'normal person' and choice_selected2 == 'number of people':
    ...
    choice_selected3 = left_column1.selectbox("Select the type of public transportration", choice3)
    df = percent_dis
    st.write(f'{style_title_graph}<p class="center-text bold-color-text">The percentage of people with disable can access to public transportration in BMR during 2020</p>', unsafe_allow_html=True)
    ...
    with col7:
        ...
        fig.update_layout(
            mapbox_style="carto-positron",
            mapbox_zoom=8.2,
            mapbox_center={"lat": 14.0, "lon": 100.52389},
            # width=1200,
            # height=800,
        )
        fig.update_layout(margin={"r": 0, "t": 0, "l": 0, "b": 0})
