...
choice_selected5 = left_column4.selectbox("Select time for show distribution", choice5)
choice6 = db.columns[1:]
choice_selected6 = right_column4.selectbox("Select air pollutant types", choice6, key='option2')
...
if f"{type(db1[choice_selected6])}" == "<class 'numpy.float64'>": #selecting 6 instead of CO
...
# =============================================================================
st.header("Comparison of Burn Area Estimates between MODIS, HIMAWARI and VIIRS Sensors for 2020-2022")
fig7 = go.Figure()
