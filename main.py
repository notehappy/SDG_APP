...
col1.image(r'Image/Ekbordinw.jpg')
...
col6.write('Position: Researcher in Sub-Project 1')
...
col8.write('Position: Sub-Project 2 Director')
...
col9.image(r'Image/Pongsakon.jpg')
