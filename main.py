...
col1.image(r'Image/Ekbordinw.jpg', width=200)
...
col3.image(r'Image/Wenchao.jpeg', width=200)
...
col5.image(r'Image/Virdis.jpeg', width=200)
...
col7.image(r'Image/Lai.jpg', width=200)
...
col9.image(r'Image/Pongsakon.jpg', width=200)
