...
col1.image(r'Image/Ekbordinw.jpg', width=500)
...
col3.image(r'Image/Wenchao.jpeg', width=500)
...
col5.image(r'Image/Virdis.jpeg', width=500)
...
col7.image(r'Image/Lai.jpg', width=500)
...
col9.image(r'Image/Pongsakon.jpg', width=500)
